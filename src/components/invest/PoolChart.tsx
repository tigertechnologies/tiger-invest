            ...
            <>
              ...
              {pnlChart && (<>
                <svg viewBox={`0 0 ${pnlChart.W} ${pnlChart.H}`} preserveAspectRatio="none" className="pcr-chart">
                  ...
                  <path d={pnlChart.path} fill="none" stroke={pnlChart.up ? '#2BFFC6' : '#FF476E'} strokeWidth="1.8" />
                </svg>
            ...
            <>
              ...
              {priceChart && (<>
                <svg viewBox={`0 0 ${priceChart.W} ${priceChart.H}`} preserveAspectRatio="none" className="pcr-chart">
                  ...
                  <path d={priceChart.path} fill="none" stroke={priceChart.up ? '#2BFFC6' : '#FF476E'} strokeWidth="1.6" />
