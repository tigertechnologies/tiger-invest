  ...
  return (
    <>
      ...
      <div className="t-card section-gap">
        <div className="mon-h"><span className="eyebrow" style={{ margin: 0 }}>Valuation · Mayer Multiple</span><b style={{ color: mayerColor, fontFamily: "'Space Grotesk', Inter, sans-serif", fontWeight: 800, fontSize: 22 }}>{mayer != null ? mayer.toFixed(2) + '×' : '—'}</b></div>
