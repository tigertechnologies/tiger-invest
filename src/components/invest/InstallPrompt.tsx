...
const card: React.CSSProperties = {
  ...
  border: '1px solid rgba(0,255,136,.35)', borderRadius: 16,
  padding: '12px 14px', boxShadow: '0 8px 32px rgba(0,0,0,.5), 0 0 24px rgba(0,255,136,.15)',
  fontFamily: 'Inter, system-ui, sans-serif',
}
const icon: React.CSSProperties = {
  width: 40, height: 40, borderRadius: 11, flexShrink: 0,
  display: 'flex', alignItems: 'center', justifyContent: 'center',
  background: 'linear-gradient(145deg,#00FF88,#19D3A2)',
  boxShadow: '0 0 18px rgba(0,255,136,.5)',
}
const ttl: React.CSSProperties = {
  fontFamily: 'Space Grotesk, sans-serif', fontWeight: 700, fontSize: 14, color: '#fff', letterSpacing: '.3px',
}
...
const btn: React.CSSProperties = {
  ...
  background: 'linear-gradient(145deg,#00FF88,#19D3A2)', color: '#fff',
  fontFamily: 'Space Grotesk, sans-serif', fontWeight: 700, fontSize: 13,
  padding: '9px 16px', borderRadius: 10, boxShadow: '0 0 16px rgba(0,255,136,.4)',
}
